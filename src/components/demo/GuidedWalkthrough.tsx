...
const steps = [
  ...
  { title: "Your Level", desc: "Your trading level shows your progression. Complete missions and trades to level up and unlock new features!", target: "demo-header" },
  { title: "Pick an Asset", desc: "Choose between Stocks, Crypto, or Forex. Then pick a symbol to trade.", target: "demo-asset-tabs" },
  { title: "Live Chart 📊", desc: "This is a real-time chart with RSI indicator. Watch price action and spot patterns before trading.", target: "demo-chart" },
  { title: "Buy or Sell", desc: "Click BUY to go long (profit when price rises). SELL unlocks at Level 3!", target: "demo-buy-sell" },
  { title: "Set a Stop Loss ⚠️", desc: "ALWAYS set a Stop Loss — it limits your downside risk. This is required before placing any order.", target: "demo-stoploss" },
  { title: "Set Take Profit 🎯", desc: "Set a target price to lock in gains automatically. Aim for at least 2:1 reward-to-risk.", target: "demo-takeprofit" },
  { title: "Check Your Risk", desc: "We show what % of your balance is at stake and your risk:reward ratio. Keep risk under 2%!", target: "demo-risk" },
  { title: "Build Your Thesis 📝", desc: "Before placing, write WHY you're taking this trade. Good traders always have a plan.", target: "demo-order-form" },
  { title: "Place the Order", desc: "Click Place Order to execute. Your position will track live P&L in real-time.", target: "demo-place-order" },
  { title: "Close & Review", desc: "When ready, close the position. Our AI will grade your trade (A-F) and suggest improvements!", target: "demo-order-form" },
];
